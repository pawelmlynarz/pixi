...
class SimpleApplication final : public BaseApplication {
  public:
    ...
    PXENGINE_API bool addWindow(SharedRef<SWindow> window, bool bShowImmediately) override;

    PXENGINE_API SharedPtr<SWindow> findWindowByPlatformWindow(SharedRef<class GenericWindow> const& platformWindow);
