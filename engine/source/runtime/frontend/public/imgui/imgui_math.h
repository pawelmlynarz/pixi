...
// ImVec2 operators
inline ImVec2  operator*(const ImVec2& lhs, const f32 rhs)      { return ImVec2(lhs.x * rhs, lhs.y * rhs); }
inline ImVec2  operator*(const f32 lhs, const ImVec2& rhs)      { return ImVec2(lhs * rhs.x, lhs * rhs.y); }
inline ImVec2  operator/(const ImVec2& lhs, const f32 rhs)      { return ImVec2(lhs.x / rhs, lhs.y / rhs); }
...
inline ImVec2& operator*=(ImVec2& lhs, const f32 rhs)           { lhs.x *= rhs; lhs.y *= rhs; return lhs; }
inline ImVec2& operator/=(ImVec2& lhs, const f32 rhs)           { lhs.x /= rhs; lhs.y /= rhs; return lhs; }
...
// ImVec4 operators
inline ImVec4  operator*(const ImVec4& lhs, const f32 rhs)      { return ImVec4(lhs.x * rhs, lhs.y * rhs, lhs.z * rhs, lhs.w * rhs); }
inline ImVec4  operator*(const f32 lhs, const ImVec4& rhs)      { return ImVec4(lhs * rhs.x, lhs * rhs.y, lhs * rhs.z, lhs * rhs.w); }
inline ImVec4  operator/(const ImVec4& lhs, const f32 rhs)      { return ImVec4(lhs.x / rhs, lhs.y / rhs, lhs.z / rhs, lhs.w / rhs); }
...
inline ImVec4& operator*=(ImVec4& lhs, const f32 rhs)           { lhs.x *= rhs; lhs.y *= rhs; lhs.z *= rhs; lhs.w *= rhs; return lhs; }
inline ImVec4& operator/=(ImVec4& lhs, const f32 rhs)           { lhs.x /= rhs; lhs.y /= rhs; lhs.z /= rhs; lhs.w /= rhs; return lhs; }
